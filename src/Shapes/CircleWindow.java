...
public class CircleWindow extends javax.swing.JFrame implements Node {
     ...
     */
    public CircleWindow(DrawingArea d,Paint paint) {
        initComponents();
        this.d=d;
        this.paint=paint;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("X CO-ORDINATE OF POINT");

        jLabel2.setFont(new java.awt.Font("Perpetua", 1, 14)); // NOI18N
        jLabel2.setText("Y CO-ORDINATE OF POINT");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String vR = jTextField3.getText();
        String hR = jTextField4.getText();
        
        
        if(!isNum(vR) || !isNum(x) || !isNum(y) || !isNum(hR))
        {
             JOptionPane.showMessageDialog(null, "Field is empty or entry is non-positive");
        } else {
            pX = Integer.parseInt(x);
            pY = Integer.parseInt(y);
            vRad = 2*(Integer.parseInt(vR));
            hRad = 2*(Integer.parseInt(hR));

            Point p = new Point(pX, pY);
            Circle circ = new Circle(p);
            circ.setPosition(p);
            circ.setHeightOval(vRad);
            circ.setWidthOval(hRad);
            
            circ.setColor(borderColor);
            ...
            jComboBoxtemp.addItem("Oval: " + ind);
            Paint.setIndex(ind);
